package com.pbl7.identity_service.exception;
...
public enum ErrorCode {
    ...
    ADDRESS_ALREADY_EXISTS(1013, "This address is already exists", HttpStatus.BAD_REQUEST),
    ADDRESS_NOT_FOUND(1014, "Address not found", HttpStatus.BAD_REQUEST),
    ACCOUNT_DISABLED(1015, "Account is disabled", HttpStatus.FORBIDDEN),
    ;
